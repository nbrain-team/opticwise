...
export function generatePostHtml(post: BlogPostData): string {
  ...
  const jsonLdArticle = JSON.stringify({
    ...
    author: {
      "@type": "Person",
      name: post.author,
      url: "https://www.opticwise.com/about",
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": canonicalUrl,

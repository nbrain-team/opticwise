  ...
  const jsonLdBreadcrumb = JSON.stringify({
    ...
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.opticwise.com" },
      {
        ...
        position: 2,
        name: "Insights",
        item: "https://www.opticwise.com/insights",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: post.title,
        item: `https://www.opticwise.com/insights/${post.slug}`,
      },
    ],
  })

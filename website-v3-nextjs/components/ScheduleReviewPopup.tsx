...
export function ScheduleReviewPopup() {
  ...
  const close = () => {
    ...
    if (success) {
      setSuccess(false);
      setForm({ firstName: "", lastName: "", email: "", company: "", phone: "", propertyType: "", message: "" });
    }
  };

  return (
    <>
      <button onClick={() => setIsOpen(true)} className="btn btn-white btn-lg">
            ...
            {success ? (
              <div className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  We&apos;ve received your request. A member of our team will reach out within one business day to schedule your review session.
                </p>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Tell us about your property or project</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
                    ...
                    placeholder="Number of units, current challenges, what you're looking to accomplish..."
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 px-6 bg-ow-blue text-white font-semibold rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm"
                >

    ...
    <div className="min-h-screen bg-white text-gray-700 font-sans">
      ...
      <nav className="bg-[#0a1628] sticky top-0 z-50">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between px-6 py-3">
          <a href="https://www.opticwise.com" className="flex-shrink-0">
            <Image src="/images/logo.svg" alt="OpticWise" width={130} height={36} priority />
          </a>
          <span className="hidden md:block text-white/80 text-sm font-medium tracking-wide">
            PPP Data &amp; Digital Infrastructure Review
          </span>
          <a href="#schedule" className="btn btn-nav text-sm">
            Schedule Review
          </a>
        </div>
      </nav>
      ...
      <section className="relative overflow-hidden bg-[#0a1628]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 pt-20 pb-32 lg:pt-28 lg:pb-40 text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-amber-400 leading-tight tracking-tight max-w-4xl mx-auto">
            Schedule your CRE Data &amp; Digital Infrastructure Review and take back control.
          </h1>
          <p className="mt-5 text-lg sm:text-xl text-amber-300/90 italic font-medium max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-base sm:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed">
            Uncover hidden costs, broken tech stacks, and missed NOI opportunities. The PPP Data &amp; Digital
            Infrastructure Review gives you clarity, fast—so you can start monetizing your building&rsquo;s data and
            digital infrastructure like the asset it is.
          </p>
        </div>
      </section>

      {/* ═══ FORM ═══ */}
      <section id="schedule" className="relative z-20 -mt-20 pb-24">
        <div className="max-w-2xl mx-auto px-6">
          <div className="rounded-2xl bg-[#0f172a]/95 backdrop-blur-md border border-white/10 shadow-2xl p-8 sm:p-10">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <label className="block">
                    ...
                    <input
                      ...
                      className="mt-1.5 block w-full rounded-lg bg-white/10 border border-white/15 text-white placeholder-white/30 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ow-blue focus:border-transparent"
                      placeholder="Jane"
                    />
                  </label>
                  <label className="block">
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    value={form.notes}
                    onChange={handleChange}
                    className="mt-1.5 block w-full rounded-lg bg-white/10 border border-white/15 text-white placeholder-white/30 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ow-blue focus:border-transparent resize-none"
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full btn btn-primary text-base py-4 mt-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {submitting ? (
      ...
      <section className="ow-section bg-gray-50">
        <div className="ow-container">
          <div className="text-center mb-14">
            ...
            <h2 className="section-heading mt-2">Comprehensive Digital Infrastructure Audit</h2>
            <p className="section-subtitle mt-4">
              Share your challenges and learn all about the comprehensive digital infrastructure audit that reveals
              hidden value and untapped potential in your commercial real estate portfolio.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {DISCOVER_CARDS.map(({ title, desc, Icon, gradient }) => (
              <div
                key={title}
                className="bg-white rounded-2xl border border-gray-200 p-7 text-center transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-ow-blue/20"
              >
        ...
        <div className="ow-container max-w-3xl">
          <div className="relative bg-gradient-to-br from-[#0a1628] to-[#0f2847] rounded-2xl p-10 sm:p-14 text-center">
            ...
            <blockquote className="text-lg sm:text-xl text-white/90 italic leading-relaxed font-medium">
              &ldquo;This review opened our eyes. We&rsquo;ve always upgraded systems, but never saw how owning the
              infrastructure itself would change our NOI. Game-changing.&rdquo;
            </blockquote>
            <div className="mt-6">
      ...
      <section className="ow-section bg-gray-50">
        <div className="ow-container">
          <div className="text-center mb-14">
            <span className="section-eyebrow">Why OpticWise</span>
            <h2 className="section-heading mt-2">Trusted by Industry Leaders</h2>
            <p className="section-subtitle mt-4">
              Join commercial real estate owners who are already maximizing their digital assets.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Helping CRE owners generate NOI from digital infrastructure",
                href: "https://www.opticwise.com/about",
                icon: (
              ...
              },
              {
                ...
                desc: "Digital Partners with global CRE companies",
                href: "https://www.opticwise.com/clients",
                icon: (
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              },
              {
                ...
                desc: "Get the best-selling CRE digital strategy book",
                href: "https://www.peakpropertyperformance.com/",
                icon: (
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <a
                ...
                className="group block bg-white rounded-2xl border border-gray-200 p-8 text-center transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-ow-blue/20 no-underline"
              >
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-ow-blue to-ow-blue-dark text-white flex items-center justify-center mx-auto mb-5">
                  {card.icon}
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-ow-blue transition-colors">
                  {card.title}
                </h3>
      ...
      <footer className="bg-[#0a1628] py-10">
        <div className="ow-container text-center">
          <Image src="/images/logo.svg" alt="OpticWise" width={120} height={32} className="mx-auto brightness-0 invert opacity-60" />
